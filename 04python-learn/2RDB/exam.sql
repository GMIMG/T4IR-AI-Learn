...
--                          PSALGRADE 테이블 생성
--------------------------------------------------------------------------
CREATE TABLE PSALGRADE
        (GRADE NUMBER(2),
         LOSAL NUMBER(5),
         HISAL NUMBER(5));

-------------------------------------------------------------------------
--                         PSALGRADE 테이블 데이터 입력
--------------------------------------------------------------------------
INSERT INTO PSALGRADE VALUES (1, 100, 300);
INSERT INTO PSALGRADE VALUES (2, 301, 400);
INSERT INTO PSALGRADE VALUES (3, 401, 500);
